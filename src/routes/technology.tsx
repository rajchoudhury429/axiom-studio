  ...
  head: () => ({
    meta: [
      { title: "Technology — AXIOM Studio" },
      {
        name: "description",
        content:
          "The technology stack powering AXIOM Studio, and why each piece is here.",
      },
    ],
  }),
  component: Tech,
            ...
            return (
              <button
                ...
                className={`text-left rounded-2xl border p-5 transition group ${
                  isOpen
                    ? "border-crimson/50 bg-crimson/[0.06] md:col-span-2 md:row-span-2"
              ...
              >
                ...
                {isOpen && (
                  <div className="mt-6 aspect-video rounded-xl border border-border bg-input grid-bg flex items-center justify-center animate-rise">
