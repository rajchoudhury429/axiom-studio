  ...
  head: () => ({
    meta: [
      { title: "Team — AXIOM Studio" },
      {
        name: "description",
        content:
          "Meet the five engineers behind AXIOM: Raj, Daniyal, Jigyashu, Banajit, and Abhijeet.",
      },
    ],
  }),
  component: Team,
...
const MEMBERS = [
  {
    name: "Raj Choudhury",
    role: "Project Lead",
    tags: ["Backend", "System Architecture", "AI Integration"],
  ...
  },
  {
    name: "Banajit",
    role: "Frontend Engineer",
    tags: ["Frontend", "UX", "Interactive Design"],
    ...
    <PageShell>
      <section className="mx-auto max-w-7xl px-6 pt-8 pb-6">
        ...
        <h1 className="hero-title mt-6 text-[clamp(2.4rem,6vw,5.4rem)]">
          Five engineers.
          <br />
          <span className="text-shine">One current.</span>
        </h1>
      </section>
          ...
          >
            <div className="flex flex-wrap items-start justify-between gap-6">
              ...
              <div className="relative">
                <div className="h-24 w-24 rounded-2xl bg-gradient-to-br from-crimson to-[var(--graphite-2)] flex items-center justify-center font-display text-3xl font-bold animate-pulse-glow">
                  {m.name
                    .split(" ")
                    .map((s) => s[0])
                    .join("")
