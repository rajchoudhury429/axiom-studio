...
//#region node_modules/.nitro/vite/services/ssr/assets/ai-service-BH7JBtfI.js
...
function ThemeProvider({ children }) {
	const [theme, setThemeState] = (0, import_react.useState)(() => getStoredTheme() ?? getSystemTheme());
...
var SYSTEM_PROMPT = `You are the AI assistant for AXIOM-AI WORKSPACE (axiom.studio). You are knowledgeable, concise, and helpful.
...
//#endregion
export { useTheme as i, ThemeProvider as n, createMessage as r, SYSTEM_PROMPT as t };
